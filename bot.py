...
# Runtime fix for 'pkg_resources' which is required by playwright-stealth
try:
    ...
    try:
        ...
        print(f"Warning: Could not install setuptools at runtime: {e}")
...
USER_AGENTS = [
    ...
    # iOS Mobile - Chrome
    "Mozilla/5.0 (iPhone; CPU iPhone OS 17_3_1 like Mac OS X) AppleWebKit/537.36 (KHTML, like Gecko) CriOS/122.0.6261.89 Mobile/15E148 Safari/537.36",
    "Mozilla/5.0 (iPhone; CPU iPhone OS 16_6 like Mac OS X) AppleWebKit/537.36 (KHTML, like Gecko) CriOS/121.0.6167.160 Mobile/15E148 Safari/537.36"
]
